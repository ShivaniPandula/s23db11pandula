...
router.get('/', function (req, res) {
  res.render('index', { title: 'AirlineTicket App', user: req.user });
});

router.get('/register', function (req, res) {
  res.render('register', { title: 'AirlineTicket App Registration' });
});
...
router.get('/login', function (req, res) {
  res.render('login', { title: 'AirlineTicket App Login', user: req.user });
});
